...
$(function () {
    $.ajax({
        type: "get",
        url: "/mininew/api/affair/getInfo",
        dataType: "json",
        data: {
            'affair_id': webData.id
        },
...
function addTab(data) {
    ...
    if (data.data.tree_img && data.data.tree_img.length != 0) {
        ...
        $("#nav-2 .bodyList").append("<img class='flowTreeImg' src='https://jbzwnew.qimixi.net" + data.data.tree_img.file_path + "'/>");
    }
