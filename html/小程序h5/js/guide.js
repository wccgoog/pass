...
$(function () {
    $.ajax({
        type: "get",
        url: "/mininew/api/total/affairList",
        dataType: "json",
        data: {
            'total_id': webData.id
        },
        success: function (data) {
            addTitle(data.data.total_info.name);
            addLb(data.data.total_info.category);
            addQljbbm(data.data.total_info.no);
            addSszt(data.data.total_info.im_sub);
            addXscj(data.data.total_info.level);
            addBz(data.data.total_info.remarks);
            addSsyj(data.data.total_info.im_bas);
            addList(data.data.affair_list)
        }
    })
});
