...
export function faceVerify(url) {
  my.ap.faceVerify({
        ...
        my.alert(
          {
            ...
            my.redirectTo({
              url: '/pages/web-view/index?requestUrl=https://jbxqalipay.nanjingdata.cn/web/wechat/modules/lowSecurity/templates/index.html?uid=' + app.uid,
            });
          }
        );
      }
